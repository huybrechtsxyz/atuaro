...
Koen - koenbras@yahoo.com / gmail account
Kristof - k_dieltiens@hotmail.com
Giuseppe - Vandenberghe_Michael@hotmail.be
Michael - triagiuseppe1@gmail.com

## Links to tools
Before you play, make sure you have access to the following links.  
You will need to create an account.

* [Discord](https://discord.gg/H9BHaVGNrz)
* [Google Drive](https://drive.google.com)
* [VTT Invite](https://eu.forge-vtt.com/invite/fatherprime/047bf03a-ec04-4eef-b041-1e6d889f980b)
* [Foundry VTT](https://fatherprime.eu.forge-vtt.com/)
//Zie discord
//* [Tavern](https://forums.forge-vtt.com/t/fatherprime/65743)

## Login
Login to the world with your name as username and password as default.

iedereen moe zijn spelers aan de character door op de plahyer list te selecteren en het juiste te kiezen.

## Tutorials
Tutorials you can use:

* [Foundry VTT](https://youtu.be/ja88yRVQmck)
...
Micheal: Mario [Harata]
half ork 
wordt vaak gepest
trekt altijd op met antonio
...
Dave: tyrion wynstone
naam moeder
vader ongekend
moeder 6 jaar lang grootgebracht
die werd gepest. hekel aan arogante mensen
die was alleenstaande.
vader: elf nooit gekend
half-elf: moeder heeft die kant laten kennne
probeert elfelijke trkken te verbergen
barbarian: klein atypisch elfs afzetten

Koen: zoon meneer pastoor [Cornus Hikoga] Kornoei bloem
aantal jaar geleden
elfd oor dorp gepasseerd
kon het kind niet houden (hoge plaats)
-not done-
meneer pastoor kon niet herknenn: celibateir
aangeboden aan het weeshuis.
pastoor is rathzinger

om gewten te susssen geld ophalen voor weeshuis.
witchling heeft vermoeden, pastoor gaf het af.
Cornus. plots de kornus bloemen begonnen plots te bloeien
geen achternaam.

mahura

> algemene nachternaam is de maand van inkom
die bloeit van voor in de tuin

>>> Waarom kunnen rollen als een andere
