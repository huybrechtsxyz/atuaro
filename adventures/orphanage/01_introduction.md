...
* [Basic Play](../../zTEMP/handbook/02_basic_play.md)
* [Table Rules](../../zTEMP/handbook/03_table_rules.md)
* [Game Rules](../../zTEMP/handbook/04_game_rules.md)

As mentioned in the Table Rules, I expect that you have a way of managing your character. The obvious ways is using a form fillable PDF or one of the many D&D character apps that are available. A few examples are the [Standard Character Sheet](../../zTEMP/public/character_sheets/character_sheet_standard.pdf) or an [Alternative Character Sheet](../../zTEMP/public/character_sheets/character_sheet_alternative.pdf). My personal preference is that you no longer use D&D Beyond in light of the O.G.L. controversy. An editable PDF, World Anvil, VTT has a good player character manager my preference would be one of these.

## Ineffable Games
Read the [introduction](./ineffable_games.md).

## Character Creation
To play in a role-playing game you will need a character. But as most players already did this plenty we are going to condense the information to what you need to know to play in Atuaro with links to relevant articles if you want to know more. As we are building a random generated character do not feel to fixated on your choices. People change with age. [Read More.](../../zTEMP/handbook/05_character_creation.md)
...
### Ability Scores
The first order of business is to create our [Ability Scores](../../zTEMP/handbook/07_character_abilities.md). Please use the Hardcore Mode to create your ability scores. For each ability score:
...
> Choose one of the playable races from the Atuaro handbook [Link](../../handbook/lineages/_overview.md)
