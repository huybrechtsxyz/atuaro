...
* Token tournament by Adam DeWees link:{rootdir}/assets/resources/tournament_of_tokens.pdf[PDF]
...
// SKIP THE STARS
Kids with good behavior get a Star. On the other hand if you mucked about you get a Bolt. Stars are awarded to the highest performing children. Any child who fails will receive a Bolt, without exception.
...
* Claude Duval, The Mothers Boy, link:{rootdir}/compendium/actors/claude_duval.adoc[Link]
* Gilad Shams, The Bully, link:{rootdir}/compendium/actors/gilad_shams.adoc[Link]
* Krista Martell, The Supervisor, link:{rootdir}/compendium/actors/krista_martell.adoc[Link]
* Pasha Lebedev, The Slacker, link:{rootdir}/compendium/actors/pasha_lebedev.adoc[Link]
* Rufina Lo Duca, The Beauty, link:{rootdir}/compendium/actors/rufina_lo_duca.adoc[Link]
* Timothy Burch, The Sad One, link:{rootdir}/compendium/actors/timothy_burch.adoc[Link]
* Witchling, The Head Mistress, link:{rootdir}/compendium/actors/witchling.adoc[Link]
...
Kegs 1 and 2 (3 leaves standing up image:{rootdir}/assets/images/symbol_beer.jpg[beer,50,50]), contain beer [PIA]

Kegs 3 and 4 (3 circles upside down image:{rootdir}/assets/images/symbol_wine.jpg[beer,50,50]), contain wine [WAINA]

Keg 5 (Circle with line, on/off symbol, image:{rootdir}/assets/images/symbol_cider.jpg[beer,50,50]), contains apple cider [APORO]
...
* Timothy Burch, The Sad One, link:{rootdir}/compendium/actors/timothy_burch.adoc[Link]
* Witchling, The Head Mistress, link:{rootdir}/compendium/actors/witchling.adoc[Link]
* *Hibiscus Tauwi*, The priest of Kainga, link:{rootdir}/compendium/actors/hibiscus_tauwi.adoc[Link]
...
* [DC7] Carnival is in town. On good behavior they can go.
...
+
What is more peculiar she seems is accompanied by a group of small, winged creatures. Surrounded by little flying creatures that seem to try to get her to go outside again. She wearisomely swats at them and says "Oh stop it. Bugger of. Find some other victim". Which they promptly do.

The pixies will bother anyone who is around and find victims in the orphanage to take outside. Once off the map, the child will be 'gone'.
...
include::{rootdir}/statblocks/pixie_corrupted.adoc[]
...
* <<_area_1_welcome>>
* <<_area_2_clown_school>>
* <<_area_3_token_tournament>>
* <<_area_4_magic_show>>
* <<_area_5_pie_eating_contest>>
* <<_area_6_displacer_beast_ride>>
* <<_area_7_open_podium>>
* <<_area_8_animal_exhibit>>
* <<_area_9_guard Room>>
* <<_area_10_central_market_square>>
...
* Witchling, The Head Mistress, link:{rootdir}/compendium/actors/witchling.adoc[Link]
* Hibiscus Tauwi, The priest of Kainga, link:{rootdir}/compendium/actors/hibiscus_tauwi.adoc[Link]
* *Pakal Zaramus*, The Bisshop of Loukotokia, link:{rootdir}/compendium/actors/pakal_zaramus.adoc[Link]
...
|===
| [big]#*Weary Willie*#
| [small]#Human Clown, Unaligned#

| image::{homedir}/assets/tokens/weary_willie.jpg[creature,150]
...
Once registered the party might choose to do other things at the carnival. Once they are ready and no other party is going through the dungeon they can start the adventure.

[cols="2a,4a",grid=rows,frame=none]
|===
| [big]#*Gormack Labirini*#
| [small]#Human, Unaligned#

| image::{homedir}/assets/tokens/gormack_labirini.png[]
...
[cols="2a,4a",grid=rows,frame=none]
|===
| [big]#*Magnifico the Magnificent*#
| [small]#Human, Unaligned, Mentor Thief#

| image::{homedir}/assets/tokens/magnifico_the_magnificent.jpg[creature,150]
...
3 tries to find the way he does it. Magnifico performs a trick where he shuffles a ball under three cups, and the players must guess which cup the ball is under. After several attempts, the players realize that Magnifico is using slight of hand to manipulate the cups and ball, and they manage to catch him in the act. +

Impressed by their skills, Magnifico decides to teach them the trick and a few other slight of hand techniques. He reveals that he used to be a thief, but he gave up his life of crime after discovering the joy of entertaining people with his magic tricks.
|===
...
| image::{homedir}/assets/tokens/barnaby_pies.jpg[creature]
...
The presenter, a flamboyant and enthusiastic man named Barnaby, is dressed in a colorful suit and top hat. He speaks into a megaphone and addresses the crowd, building up excitement for the contest.

| *Pie Eating Game [CON DC+2]* | 
> Once the are alone with them in a tent he says. Mmh. Maybe one of you is smart enough to figure it out? Yes? I will give you three time to do so.
...
|===
| [big]#*Bofur*#
| [small]#Dwarf, Unaligned#

| image::{homedir}/assets/tokens/bofur_beast_ride.jpg[creature]
...
| *Displacer Beast Game [STR DC+2]* | 
Keep making an DC14 strength check to stay on the bull. If you fall of make a DC10 strength check to make certain you do not get damaged [1 Damage]. Stay on the bull the longest? Add 1 to your STR score.
...
- What is the difference between a snow man and snow woman? Snowballs!

=== Area 8 - Animal Exhibit

[cols="2a,4a",grid=rows,frame=none]
|===
| [big]#*Zephyrion Nightshade*#
| [small]#Human, Lawful Neutral#

| image::{homedir}/assets/tokens/zephyrion_nightshade.jpg[creature]
...
Erevan, one of the Tythingman is sleeping on the bedrol. Fail a stealthcheck to awaken him. If other guards see you enter they will call out to leave the place alone. Inside there is a short sword, shield, dagger, and a spear. And a set of cloth armor.  
The treasury map is on the table.

[cols="2a,4a",grid=rows,frame=none]
|===
| [big]#*Erevan, a tythingman*#
| [small]#Human, Lawful Neutral#

| image::{homedir}/assets/tokens/city_guard.jpg[creature,150]
...
=== Area 10 - Central Market square
*DC of 10*

> The center of the carnival is a bustling marketplace where vendors have set up colorful stalls to sell their wares. The stalls are arranged in neat rows, each one adorned with bright banners and flags that flap in the breeze. The smell of cooking food wafts through the air, mingling with the sounds of laughter, music, and chatter. The vendors are a diverse group, selling everything from fresh produce to handmade crafts, clothing, and trinkets. Their wares are displayed in colorful arrays, catching the eye of passersby with their vibrant hues and intricate designs.
...
include::{rootdir}/compendium/actors/willow_greenleaf.adoc[]
...
. All the rooms in the dungeon have a challenge.
...
> 
> Inside you see a small square room with shelves lining the walls with various items. "You can pick one and only one item from the wall.". He is suddenly distracted by someone that is in the hallway and moves to the door.
...
This room has the potential to be the first combat encounter the party has. 

* The clockwork soldiers will only attack if they are touched.
* There is one Chip of Valour in the hanging chandelier 15 feet above the ground (perception check to discover it)
* There is one chip in the chest of the clockwork soldier on the left (perception/investigation check to discover it and sleight of hand check to grab through the spinning gears without touching the soldier, waking it up)
...
|===
| [big]#*Medusa*#
| [small]#Statue, Unaligned#

| image::{homedir}/assets/tokens/medusa.png[creature,200]
...
[cols="2a,4a",grid=rows]
|===
| [big]#*Clockwork Spider*#
| [small]#Large construct, Unaligned#

| image::{homedir}/assets/tokens/clockwork_spider.png[Creature]
...
!===
^! *STR*     ^! *DEX*     ^! *CON*     ^! *INT*     ^! *WIS*     ^! *CHA*
^! 14 (*+2*) ^! 16 (*+3*) ^! 12 (*+1*) ^!  2 (*-4*) ^!  4 (*-3*) ^!  4 (*-3*)
!===

Skills: Stealth +5 +
Damage Immunities:  Poision, Psychic +
Condition Immunities: Blinded, Charmed, Deafened, Exhaustion, Frightened, Paralyzed, Petrified, Poisoned +
Senses Blindsight 60 ft., Darkvision 60 ft., Passive Perception 10 ft.
...
*Bolt.* +
Ranged Weapon Attack: +3 to hit, range 30/60 ft., one creature. +
Hit: The target takes 1d8 lightning damage

2+ |
*Spider Climb* +
The spider can climb difficult surfaces, including upside down on ceilings, without needing to make an ability 
check
|===
...
|===
| [big]#*Mimic*#
| [small]#Medium Monstrosity (shapechanger), neutral (CR 2 for 450 XP)#

| image::{homedir}/assets/tokens/mimic.png[Creature]
...
While the mimic remains motionless, it is indistinguishable from an ordinary object. The mimic has advantage on attack rolls against any creature grappled by it.
|===

=== Area 8 - Clockwork Dragon
*DC of 12*
...
[cols="2a,4a",grid=rows]
|===
| [big]#*Clockwork Dragon*#
| [small]#Medium Construct, unalligned (CR 2 for 450 XP)#

| image::{homedir}/assets/tokens/clockwork_dragon.png[Creature]
...
The clockwork dragon exhales steam in a 15-foot cone. Each creature in that area must make a DC 12 Dexterity saving throw, taking 14 (4d6) fire damage on a failed save, or half as much damage on a successful one.
