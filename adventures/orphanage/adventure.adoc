...
Keep making an DC14 strenght check to stay on the bull. If you fall of make a DC10 strength check to make certain you do not get damaged [1 Damage]. Stay on the bull the longest? Add 1 to your STR score.
