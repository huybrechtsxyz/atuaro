...
The ghost launches a barrage of objects, debris, and furniture before it. Each creature in a 15-foot cube originating from the ghost 
must make a Constitution saving throw (DC 13), taking 10 (3d6) bludgeoning damage on a failed save and half as much on a successful one. Creatures that fail their saving throw are also pushed 10 feet away from the ghost.
