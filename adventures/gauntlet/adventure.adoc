...
> As Gundren is talking about the cave, you round a bend in the road and find your way blocked by a fallen tree. The dense forest and rough terrain make it impossible to drive the cart around the roadblock. Gundren asks one of you to move the dead tree. He has an axe if needed.

*Clearing the dead fall DC15*
Strength Check (with advantage: if multiple adventurers work together) to drag the dead fall off the road. +
Success: 
Failure: The dead fall is too heavy for that hero to move on their own.

include::{rootdir}/compendium/weapons/handaxe.adoc[]
...
>If they cannot, they will have to find other ways to remove the dead fall. If they cannot think of anything, Oona will give them an axe and ask them to 
break up the dead fall. Once the roadblock is cleared, the heroes get back into position before the party moves on.In this encounter, you will explain how the game uses ability scores and ability checks to resolve the heroes’ actions. You might also have to explain how to roll with advantage.
...
image::{homedir}/assets/maps/silverpine_2_road_combat.png[align=center]
...
> It has been two days since you left Kainga. Gundrun Oona addresses each of the players in turn, asking questions to strike up a conversation. Once you have interacted with several of the heroes or if the players seem bored by the interaction, the 
encounter is over.
=== The Roadblock
[DC of 15]

> As Gundren gently manages the cart, you round a bend in the road and find your way blocked by a fallen tree. The dense forest and rough terrain make  it  impossible  to  drive  the  cart  around  the  roadblock.  

The  heroes  must  move  the  dead  fall.  If  they  cannot,  they  
...
There is a roadblock. When they try to remove the roadblock they will be attacked by a snake. (or the horse which would be worse).
