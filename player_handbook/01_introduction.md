...
Check this Player Handbook [APHB] for any rules that will affect your play of the game. Ultimately, the Dungeon Master [DM] is the authority on the campaign and the setting. By default only information from this APHB is usable. The core rules of Dungeons and Dragons are supported (even if not mentioned) unless specifically overruled in this book.

This introduction should get you started. Player Options helps you create a character, providing the rules and guidance you need to make the character you'll play in the game. It includes information on the various lineages, classes, backgrounds, equipment, and other customization options that you can choose from. Many of the rules here rely on material in other parts. If you come across a game concept  that you don't understand, consult the index or use the search function.

The house rules details the rules of how to play the game that overrule the standard rules. It covers the kinds of die rolls you make to determine success or failure at the tasks your character attempts, and describes the three broad categories of activity in the game: exploration, interaction, and combat.