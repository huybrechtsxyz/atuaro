...
### In Short
- Which sources are allowed? Default: only this player handbook.
- Do you allow optional features (Feats, Multiclassing, ...)? Default: no.
- How do you advance in levelling? Milestone vs XP. Default: milestone.
- How do you calculate hitpoints? Fixed per class, hit die, with/without con? Default: Hit die without con.
- Do you use encumbrance? Default: yes.
- Do we ignore coin weight? Default: no.
