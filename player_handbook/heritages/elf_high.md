...
| High Elf Weapon Training | You have proficiency with rapiers and longswords. |
| Magical Versatility | You know a cantrip of your choice, which can be chosen from any spell list. Your spellcasting ability score for this cantrip is Intelligence, Wisdom, or Charisma (whichever is highest). |
| Languages | You can speak, read, write, and sign in Common, Elvish, and one other language. |

## Related Links
- [Character Creation](../20_character_creation.md)
- [Character Heritages](../23_character_heritage.md)